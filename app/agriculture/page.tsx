        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 60 }}>
            ...
            <Link href="/admin" style={{
              display: 'inline-block', marginTop: 16, background: '#1B4332',
              ...
              <Link key={p.id} href={`/produit/${p.id}`} prefetch={true} style={{ textDecoration: 'none' }}>
                <div style={{ background: 'white', borderRadius: 12, overflow: 'hidden', border: '1px solid #E8D5B0', cursor: 'pointer' }}>
                  ...
                  <div style={{ padding: 12 }}>
                    ...
                    <div style={{ fontSize: 11, marginBottom: 8, color: p.stock > 0 ? '#1B4332' : '#e53e3e', fontWeight: 600 }}>
                    ...
                    <button
                      ...
                      disabled={p.stock === 0}
                      style={{
                        width: '100%', background: p.stock > 0 ? '#1B4332' : '#9CA3AF',
